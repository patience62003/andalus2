...
function Button({label,href,comingSoon=false}:{label:string;href?:string;comingSoon?:boolean;}){
  ...
  if(comingSoon||!href){
    return (
      <button onClick={()=>alert("This file will be uploaded soon.")} className={base}>
    ...
    <main className="min-h-screen bg-slate-50 text-slate-900">
      ...
      <header className="max-w-6xl mx-auto px-6 py-10">
        ...
        <p className="mt-5 max-w-3xl text-slate-700">
          Students memorize the Qur&apos;an, study al-Qurtubi line-by-line, and master math, science, engineering, and computer science — with <span className="font-semibold">no homework</span>. No Arabic needed upon entry; placement supports Arabic-from-zero.
        </p>
        <div className="mt-6 flex flex-wrap items-center gap-3">
          <Button label="Download Brochure (PDF)" href="/Investor_Deck_2pg_v4.pdf" />
          <Button label="5-Year Financials" href="/FiveYear_PnL_AAC_like_$2000tuition_v4.pdf" />
        </div>
      </header>

      <section className="max-w-6xl mx-auto px-6 pb-4">
        <div className="grid gap-6 md:grid-cols-2">
          <Card title="Full Hifz" emoji="🕋">Saba-manazil rotation: students review the entire Qur&apos;an weekly and complete memorization with in-school practice only.</Card>
          ...
          <Card title="Qurtubi Focus" emoji="📜">Comparative fiqh and ahkam through al-Qurtubi&apos;s tafsir; maqasid and balagha via classical poetry and language studies.</Card>
      ...
      <Section id="qurtubi" title="Why a Qurtubi School?" intro="Grounded in Maliki heritage and Andalusian synthesis of din and science.">
        <div className="grid gap-6 md:grid-cols-3">
          <Card title="Integrated Theology" emoji="🧭">Aqida, ahkam, sira, hadith cross-referenced as the tafsir progresses—students see the whole din in one curriculum.</Card>
      ...
      <Section id="ai" title="AI-first STEM" intro="Practical engineering from day one; HS pathways target ML, data science, robotics, and ethical AI.">
        <div className="grid gap-6 md:grid-cols-3">
          ...
          <Card title="High School" emoji="🧠">Tracks in ML, data engineering, and robotics; capstones serve community needs on the Casa–Kenitra–Tangier corridor.</Card>
        </div>
      </Section>
      ...
      <Section id="curriculum" title="Curriculum Overview" intro="Two equal halves: Qur&apos;an/Qurtubi (humanities embedded) and AI-forward STEM in English.">
        <div className="grid gap-6 md:grid-cols-2">
          <Card title="Qur&apos;an & Qurtubi" emoji="📚">Daily hifz + tafsir seminars; fiqh, hadith, balagha, prosody, and Andalus literature integrated. English class (MCCR ELA) supports STEM comprehension.</Card>
      ...
      <Section id="admissions" title="Admissions" intro="Simple, family-friendly process.">
        <ol className="list-decimal list-inside text-sm text-slate-700 space-y-2">
          ...
          <li>Decision & onboarding.</li>
        </ol>
      </Section>

      <Section id="downloads" title="Downloads">
        <div className="flex flex-wrap gap-3">
          <Button label="Brochure (2-page PDF)" href="/Investor_Deck_2pg_v4.pdf" />
          <Button label="Info Sheet (PDF)" href="/Andalus_Investor_Summary_v2.pdf" />
          <Button label="Tuition & Fees (Year 1)" href="/Tuition_and_Fees_Y1_Public_v4.pdf" />
          ...
          <Button label="5-Year P&L (PDF, AAC-like costs)" href="/FiveYear_PnL_AAC_like_$2000tuition_v4.pdf" />
          <Button label="5-Year Financials (Excel, AAC-like costs)" href="/Andalus_5yr_PnL_AAC_like_with_OPEX_v4.xlsx" />
      ...
      <footer className="max-w-6xl mx-auto px-6 py-12 text-sm text-slate-600">
        ...
        <p className="mt-6 text-xs text-slate-500">
          Standards cited: Massachusetts STE 2016; Math 2017; DLCS 2016. English benchmark: Maryland MCCR ELA (K–12).
        </p>
      </footer>
    </main>
  );
